...
BEGIN TRY
    ...
    DECLARE
        ...
        = CASE
            ...
            ELSE (SELECT o.orderType_ID FROM dbo.OrderType_ID AS o WHERE o.OrderType_Desc = 'Prepaid Activation Refund')
        END,
    ...
    WHILE @@FETCH_STATUS = 0
        BEGIN
            ...
            INTO @ProductID, @ReverseAmount, @ReverseOrdertypeID, @ReverseAccountID, @ReverseAuthNumber, @REMOVEORDER
        END
